...
function RegisterWorkshopForm({ workshop }: WorkshopProps) {
  ...
  return (
    <article className="register-form-overlay-workshop">
      <form
      ...
      >
        <div className="register-form-container-title-button">
          <h2 className="register-form-title">Réserver un atelier</h2>
          <button
            type="button"
        ...
        <ul className="register-form-events-infos-container">
          ...
          <li className="register-form-events-infos-row">
            {workshop.price_unit === 0 ? "Gratuit" : `${workshop.price_unit} €`}
          </li>
        </ul>
...
export default RegisterWorkshopForm;
