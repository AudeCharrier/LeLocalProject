...
(1,'L\'Agora','Openspace pensé pour accueillir les coworkers dans un environnement ouvert, dynamique et propice aux échanges.',50,'/assets/images/spaces/openspace/openspace.png',8.00,'Coworking','Openspace'),
(2,'Le Forum','Openspace spacieux et modulable offrant de nombreuses places de travail dans un cadre confortable favorisant la collaboration et la convivialité.',50,'/assets/images/spaces/openspace/openspace.png',8.00,'Coworking','Openspace'),
(3,'L\'Atrium','Openspace lumineux à capacité réduite, idéal pour celles et ceux qui recherchent un environnement de travail plus calme tout en bénéficiant de la vie du Local.',20,'/assets/images/spaces/openspace.png',8.00,'Coworking','Openspace'),
(4,'Le Parvis','Openspace accueillant et accessible, proposant une ambiance sereine et un nombre limité de postes pour un confort de travail optimal.',20,'/assets/images/spaces/openspace/openspace.png',8.00,'Coworking','Openspace'),
(5,'L\'Hémicycle','Grande salle de réunion du Local, conçue pour accueillir des présentations, séminaires, ateliers et rencontres professionnelles dans un cadre confortable et fonctionnel.',40,'/assets/images/spaces/meeting-room/meeting-room.png',80.00,'Coworking','Salle de réunion'),
(6,'Le Sénat','Salle de réunion dédiée aux échanges professionnels, idéale pour les comités de pilotage, réunions d\'équipe et rendez-vous avec des partenaires ou clients.',10,'/assets/images/spaces/meeting-room/meeting-room.png',60.00,'Coworking','Salle de réunion'),
(7,'La Rotonde','Salle de réunion à taille humaine offrant un cadre propice aux discussions, à la prise de décision et aux réunions de travail en petit groupe.',8,'/assets/images/spaces/meeting-room/meeting-room.png',40.00,'Coworking','Salle de réunion'),
...
(14,'L\'Atelier Voltaire','Espace dédié à l\'impression 3D, au prototypage et à la fabrication numérique.',1,'/assets/images/workshop/voltaire.png',10.00,'Ateliers','Atelier'),
(15,'L\'Atelier des Couleurs','Espace créatif dédié à la peinture, aux arts plastiques et aux activités artistiques.',1,'/assets/images/workshop/couleurs.png',10.00,'Ateliers','Atelier'),
(16,'L\'Atelier des Étoffes','Espace équipé pour la couture, la création textile et les travaux de confection.',1,'/assets/images/workshop/etoffes.png',15.00,'Ateliers','Atelier'),
(17,'L\'Atelier Gutenberg','Espace dédié à l\'impression, à la reprographie et à la production de documents.',1,'/assets/images/workshop/atelier.png',2.00,'Ateliers','Atelier'),
