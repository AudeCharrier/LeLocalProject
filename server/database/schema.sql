...
(14,'L\'Atelier Voltaire','Espace dédié à l\'impression 3D, au prototypage et à la fabrication numérique.',5,'/assets/images/spaces/workshop/voltaire.png',10.00,'Ateliers','Atelier'),
(15,'L\'Atelier des Couleurs','Espace créatif dédié à la peinture, aux arts plastiques et aux activités artistiques.',8,'/assets/images/spaces/workshop/couleurs.png',10.00,'Ateliers','Atelier'),
...
(13,1,12,'2026-09-10','2026-09-10','Soiree cinema en plein air avec projection sur grand ecran.',5,'https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?w=800&h=600&fit=crop&auto=format','Cinema plein air septembre', 2, 'approved'),
(14,2,13,'2026-09-25','2026-09-25','Concert acoustique avec artistes emergents du quartier.',8,'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=800&h=600&fit=crop&auto=format','Concert acoustique septembre', 2, 'approved'),
